...
(custom-set-variables
 ...
 '(ignored-local-variable-values '((system-time-locale . "C")))
 '(package-selected-packages nil)
 '(safe-local-variable-values
   '((compilation-search-extra-path "./" "./agent" "./agent/catalog_client"
                                    "./agent/cmd" "./agent/peer_client"
                                    "./agent/server" "./agent/store" "./catalog"
                                    "./catalog/cmd" "./catalog/server"
                                    "./example_server/cmd"
                                    "./example_server/server"
                                    "./internal/cache_config" "./internal/fs"
     ...
     (elisp-lint-indent-specs (vulpea-utils-with-file . 1)
                              ...
                              (org-with-point-at . 1) (org-element-map . 2))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(my-org-double-caret-highlight ((t (:box (:line-width (2 . 2) :color "gray25" :style released-button))))))
